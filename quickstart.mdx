---
title: "Quickstart: Install and Use the BitMart Node.js SDK"
...
<Note>
  The package uses the **Web Crypto API** for request signing. Node.js v18 has reached end of life — the current Node.js LTS (v22 or above) is recommended. If you need to run on an older release, inject a custom `customSignMessageFn` using Node's native `createHmac` as shown in the [Authentication](/authentication#custom-signing) page.
</Note>
