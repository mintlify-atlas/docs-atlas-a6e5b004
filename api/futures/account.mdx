---
title: "BitMart Futures Account & Asset REST API Reference"
...
<ParamField query="rebate_start_time" type="number">
  Rebate period start time (Unix ms).
</ParamField>

<ParamField query="rebate_end_time" type="number">
  Rebate period end time (Unix ms).
</ParamField>

<ParamField query="register_start_time" type="number">
  Filter by user registration start time (Unix ms).
</ParamField>

<ParamField query="register_end_time" type="number">
...
<ParamField query="type" type="number" required>
