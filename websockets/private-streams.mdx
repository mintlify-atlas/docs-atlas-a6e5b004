---
title: "Subscribe to Private BitMart WebSocket Streams"
...
<Steps>
  ...
  <Step title="Balance Updates">
    ...
    ```typescript
    // Balance updates — use the asset name as the symbol
    client.subscribe('spot/user/balance:USDT', 'spot');

    // The special BALANCE_UPDATE topic covers all assets
